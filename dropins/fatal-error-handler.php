...
final class WP_Aware_Errors_Fatal_Handler extends WP_Fatal_Error_Handler
{
    protected function display_default_error_template($error, $handled): void
    {
        ...
        echo '<title>Fatal Error — WP Aware Errors</title><style>html,body{margin:0;padding:0;width:100%;min-height:100vh;min-height:100dvh;background:#0b0d10}body{color:#edf2f7;font:15px/1.55 system-ui,sans-serif}.x{width:100%;max-width:none;min-height:100vh;min-height:100dvh;margin:0;padding:32px 40px;display:flex;flex-direction:column}.k{color:#ff5a36;text-transform:uppercase;letter-spacing:.12em;font-size:11px;font-weight:800}h1{font-size:20px;margin:8px 0}.m{font-size:30px;line-height:1.15;font-weight:750;letter-spacing:-.025em}.s{display:flex;gap:12px;margin:24px 0}.c{flex:1;border:1px solid #252b33;background:#11151a;border-radius:12px;padding:15px}.c span{display:block;color:#8e99a8;font-size:11px;text-transform:uppercase}.code{border:1px solid #252b33;background:#11151a;border-radius:12px;padding:12px 0;font:13px/1.65 ui-monospace,monospace;overflow:auto}.l{display:grid;grid-template-columns:60px minmax(700px,1fr);padding:0 16px}.l b{color:#5e6976;text-align:right;padding-right:16px}.l.hot{background:rgba(255,90,54,.12);box-shadow:inset 3px 0 #ff5a36}.l.hot b{color:#ff5a36}.n{color:#7e8996;margin-top:auto;padding-top:20px}</style>';
